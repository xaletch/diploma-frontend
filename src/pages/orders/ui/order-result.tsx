            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                {data.bookings.map((booking, idx) => (
                  <div key={idx} className="grid grid-cols-[48px_1fr_140px]">
                  <div className="relative">{idx+1}</div>
                  <div>
                  ...
                  <div className="text-base font-bold flex flex-col items-end">
                    <p>{formatPrice(booking.service.price.price)} ₽</p>
                  </div>
                  </div>
                ))}
              ...
              <div className="flex items-center justify-between gap-2.5">
                ...
                <p className="font-medium">{formatPrice(data.subtotal)} ₽</p>
              </div>
              ...
              <div className="flex items-center justify-center gap-2.5">
                ...
                {(data.status === "paid" || data.status === "closed" || data.status === "unpaid") && (
